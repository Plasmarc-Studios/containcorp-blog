...
<div style="display:flex">
     <div style="flex:1;padding-right:10px;">
          <img src="./forensic-friday-media/ff39/side1.png" width="100%"/>
     </div>
     <div style="flex:1;padding-left:10px;">
          <img src="./forensic-friday-media/ff39/side2.png" width="100%"/>
     </div>
</div>
