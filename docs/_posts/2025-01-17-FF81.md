...
We knew this months in advance that the deadline for entering Next Fest was earlier this week, but what we failed to see was that a trailer was highly recommended for any game signing up, so over a panicked weekend, and spilling into this week, we got to work on making a trailer (for which we didn't even make the deadline anyway... but it worked as a good incentive nonetheless!). Blood, sweat and tears were spilt, and David now has a lasting injury due to overdoing it, but at least we now have a finished trailer!
