...
Jokes aside, the merch store is close to being finished - we're just going to do some product quality tests before selling anything, since selling bad quality stuff isn't what we do here + we don't have a full-time customer support agent at Plasmarc Studios, yet! This will likely take a few weeks, then we'll officially open the store. It's our first time creating anything of this sort, but everything seems to be working as intended so fingers crossed we aren't setting a random server on fire somewhere!

The merch shop will (hopefully) help us fund some future community events, general upkeep of our online presence like our website and this blog that you're reading on, some kickstarter incentives with discount codes + it's just cool having game specific merch to rep ourselves! We've previously only had merch as part of our "Field Agent" tier and higher on [patreon](https://www.patreon.com/c/containcorp). I've always tried to be as transparent as possible that we don't expect any patrons, but if you want to help support us long term then that is the best place to do so, and in return you could get some exclusive merch + some exclusive early news about what we're up to. However, if you just want to get your hands on some physical items straight away, now you will be able to!

# Playtesting to the Masses

We believe the game is in a good enough state (game design and game-breaking bugs wise) that we will now be happy for anyone playtesting to stream or release public videos showing Containcorp. We do want to remind people that the game is in the earliest pre-alpha stage, so bugs will inevitably be a problem, but we are happy for any videos containing in-game footage / early thoughts on the game etc. and actively encourage people to do so (with an accompanying link to our website appreciated - [https://containcorpgame.com/](https://containcorpgame.com/))! Of course, feel free to plug yourself in our Discord if you do, and if you have any questions / queries then reach out to us and let us know!
...
> We got a first listen to the trailer music composed by [Can](https://www.fcanerdogan.com/), which you can find in [Forensic Friday 71](https://plasmarcstudios.co.uk/containcorp-blog/ff71#trailer-music)
...
> The creepy mask returned again AND IT PRANKED US GODDAMNIT
...
> We finally released the game in pre-alpha!
...
> With a few game breaking bugs and design issues delaying key releases, civil unrest occurred...
