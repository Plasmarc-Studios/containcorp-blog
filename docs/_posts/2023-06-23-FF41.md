...
desc: "Welcome, all, to Forensic Friday 41! As usual, we'll go through everything we've been up to this week game development wise, along with a few additions such as the Anomaly of the Week poll winner, as well as progress on our new steam page! Let's get the anomaly of the week out of the way first..."
...
Take a look at the steampage so far. It's almost ready, just missing a screenshots and a few images. Especially the storyteller assets, which aren't done yet!
...
Before we move onto new features pertaining to combat, we should introduce some polish we have been undergoing so we can get better screenshots for the steam page. So lets dive in!

### NPCs now move with acceleration: Groovy!
There are still a few kinks to iron out (like NPCs getting stuck in infinite circling loops) but so far I am liking it. NPC movement looks a lot less rigid now.
...
### New Art assets
Call this a week of art would be an understatement! Sicne we are working full time, we have also freed up the very much needed time to new art assets. Time to ditch all those placeholders! Many of you would have got a glimpse of these with the [Previous Forensic Friday](/ff40) where mortars had actual sprites instead of the usual nondescript placeholder. Well, exciting stuff is in store when I introduce the main combat feature that has been worked on this week! But first lets see what new art assets have been made `＼（〇_ｏ）／`
...
Not very exciting but the mouse over UI is finally back from the dead, after being killed in the process of the UI overhaul. Bo much to say here, but take a look at the comparison!

![old](./forensic-friday-media/ff41/olduipng) | ![new](./forensic-friday-media/ff41/newui.png)

### New Region Icons in Architect Menu

![new](./forensic-friday-media/ff41/regionui.png)

Regions in the architect menu now have icons, which helps a considerable amount, before it was almost impossible to tell what a region was for, unless you could memorize all the colors, which we are too lazy to do! Well, worry no more, this issue has been fixed.

### New Wall type: Piped Walls

![new](./forensic-friday-media/ff41/pipwall.png)

Not much to say here other than the game now has walls which are simultaneously pipes. How crazy! Don't mind the outdated terrain in this old screenshot. Any ado.

### New Wall Shading Effect

We now have a new effect with walls, that just adds a little spice!

![new](./forensic-friday-media/ff41/spice.png)

## New Combat Features

I am on the tail end of the combat system as a whole, and things are starting to get quite interesting. Well... most of the cool stuff is already said and done, inlcuding this! This week I introduce you to... 
### Razorwire
...
The most exciting feature this week as probably been turrets. 
