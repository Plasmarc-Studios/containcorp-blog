...
description: "What's up everyone! Back again for a Forensic Friday that if all goes to plan is actually on a Friday! More updates on our new UI, as well as a quick look into what we've been cooking with a revamped damage system, a whole new website, where we are along our road map AND some embarrassing stats (well for me anyway) :')
