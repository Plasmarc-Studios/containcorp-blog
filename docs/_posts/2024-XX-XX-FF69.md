...
We now have a new logisics view to help simplify the process of building anything logistical. This is extremely important in our game since logistics are about to get that little more wild with 3 dimensions to work with. In the logistics view, you'll be able to view and edit your fluid and electrical layouts.
